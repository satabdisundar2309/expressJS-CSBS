...
// NOTE: If you trry to write any route after writing the page not found route, then it will always take you to page not found. Hence alwsays write the page nopt found route after defining all the routes you want to write. 
app.get("*",(req,res)=>{
